...
class Ship(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # Start each new ship and the bottom of the screen.
    ...
    def update(self):
        ...
        if self.mover_right and self.rect.right < self.screen_rect.right:
    ...
    def blitme(self):
        """Draw the sheep at its current location."""
