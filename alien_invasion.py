...
class AlienInvasion:
    ...
    def _update_bullets(self):
        self.bullets.update()
        # Get read of bullets that have disappeared.
    ...
    def _create_fleet(self):
        ...
        alien = Alien(self)
        # Estimating the number of aliens that can fit in a row.
    ...
    def _update_aliens(self):
        ...
        then update the position on the screen."""
